...
def format_main_menu() -> str:
    return (
        "⚡ <b>Pokémon Daily</b>\n\n"
        "Открывай новых покемонов, собирай свою коллекцию "
        "и следи за прогрессом.\n\n"
        "Каждая новая карточка содержит описание, способности, "
        "интересный факт и эволюционную цепочку.\n\n"
        "Выбери действие:"
    )
...
def format_about() -> str:
    return (
        "ℹ️ <b>О проекте</b>\n\n"
        "<b>Pokémon Daily</b> — бот, который помогает постепенно "
        "собрать собственную коллекцию покемонов.\n\n"

        "🎁 Получай новых покемонов\n"
        "📚 Собирай коллекцию\n"
        "⭐ Добавляй любимых в избранное\n"
        "📊 Следи за своим прогрессом\n\n"

        "Каждая карточка содержит русское описание, типы, способности, "
        "интересный факт и эволюционную цепочку покемона.\n\n"

        "Pokémon Daily — некоммерческий учебный проект и не связан "
        "с Nintendo, Game Freak или The Pokémon Company."
